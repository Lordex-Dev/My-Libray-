...
local redzlib = {
	...
	SkyTheme = {
    ["BackgroundImage"] = "rbxassetid://138503740365352", -- Minha imagem 
    ["Color Stroke"] = Color3.fromRGB(40, 80, 200),
    ["Color Theme"] = Color3.fromRGB(90, 150, 255),
...
local MainFrame = Create("Frame", {
    Name = "MainFrame",
    Parent = ScreenGui,
    Size = UDim2.fromOffset(redzlib.Save.UISize[1], redzlib.Save.UISize[2]),
    Position = UDim2.fromScale(0.5, 0.5),
    AnchorPoint = Vector2.new(0.5, 0.5),
    BackgroundColor3 = redzlib.Themes[redzlib.Save.Theme]["Color Hub 2"] or Color3.fromRGB(30,30,30),
    BorderSizePixel = 0,
    BackgroundTransparency = 0
})

-- Suporte para fundo com imagem
if redzlib.Themes[redzlib.Save.Theme] and redzlib.Themes[redzlib.Save.Theme]["BackgroundImage"] then
    local bg = Instance.new("ImageLabel")
    bg.Name = "BackgroundImage"
    bg.Image = redzlib.Themes[redzlib.Save.Theme]["BackgroundImage"]
